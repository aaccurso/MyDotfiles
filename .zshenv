...
ANDROID_HOME=$DEV_HOME/adt-bundle-linux-x86_64-20131030/sd
...
CROSSWALK_HOME=$DEV_HOME/crosswalk-$CROSSWALK_VERSION
[[ -d $CROSSWALK_HOME ]] && export CROSSWALK_HOME && export PATH=$PATH:$CROSSWALK_HOME/bin
